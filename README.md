...
14. ### What is the useRouter hook in Next.js?

    A hook that allows access to the router object and perform navigation.

    [:arrow_up: Back to Top](#table-of-contents)

15. ### How do you navigate programmatically in Next.js?
...
24. ### What is the Image component in Next.js?
...
25. ### What is next.config.js?

    A configuration file to customize Next.js settings.

    [:arrow_up: Back to Top](#table-of-contents)

26. ### How do you enable TypeScript in a Next.js project?

    By adding a tsconfig.json file.

    [:arrow_up: Back to Top](#table-of-contents)

27. ### What is API Routes in Next.js?

    A feature to create API endpoints in the `pages/api` directory.

    [:arrow_up: Back to Top](#table-of-contents)

28. ### How do you deploy a Next.js app to Vercel?

    By connecting the repository to Vercel and deploying it.

    [:arrow_up: Back to Top](#table-of-contents)

29. ### What is pre-rendering in Next.js?

    Generating HTML for pages in advance, instead of on each request.

    [:arrow_up: Back to Top](#table-of-contents)

30. ### What is the difference between static generation and server-side rendering?
...
33. ### How do you fetch data in a Next.js page?
...
42. ### What is the default port for a Next.js app?

    Port 3000.

    [:arrow_up: Back to Top](#table-of-contents)

43. ### How do you add custom headers in Next.js?

    By configuring headers in next.config.js.

    [:arrow_up: Back to Top](#table-of-contents)

44. ### What is Fast Refresh in Next.js?

    A feature for quick feedback when editing React components.

    [:arrow_up: Back to Top](#table-of-contents)

45. ### What is the public folder in Next.js?

    A folder for static assets served from the root URL.

    [:arrow_up: Back to Top](#table-of-contents)

46. ### How do you configure a custom Babel setup in Next.js?

    By adding a babel.config.js file.

    [:arrow_up: Back to Top](#table-of-contents)

47. ### How do you handle internationalization (i18n) in Next.js?

    By configuring i18n settings in next.config.js.

    [:arrow_up: Back to Top](#table-of-contents)

48. ### What is React Strict Mode in Next.js?

    A development mode that highlights potential problems in an application.

    [:arrow_up: Back to Top](#table-of-contents)

49. ### What is a singleton router in Next.js?
...
101. ### How do you manage cookies in Next.js?

     Using libraries like cookie or js-cookie to set and retrieve cookies.

     [:arrow_up: Back to Top](#table-of-contents)

102. ### How do you handle authentication tokens in Next.js?
