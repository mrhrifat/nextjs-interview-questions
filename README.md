...
15. ### What is the Link component in Next.js?
...
16. ### What is the useRouter hook in Next.js?
...
22. ### What is static site generation (SSG) in Next.js?

    Pre-rendering pages at build time.

    [:arrow_up: Back to Top](#table-of-contents)

23. ### What is server-side rendering (SSR) in Next.js?

    Rendering pages on each request.

    [:arrow_up: Back to Top](#table-of-contents)

24. ### What is incremental static regeneration (ISR) in Next.js?

    Re-generating static pages at runtime as traffic comes in.

    [:arrow_up: Back to Top](#table-of-contents)

25. ### What is the Image component in Next.js?
